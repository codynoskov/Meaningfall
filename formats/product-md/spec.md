...
This format spec follows the repository-level contract in [`../../SPEC.md`](../../SPEC.md). It inherits the root public-surface and contract rules, and narrows or extends them only where this spec says so explicitly.
...
Spec: https://github.com/codynoskov/Meaningfall/blob/main/formats/product-md/spec.md
```
